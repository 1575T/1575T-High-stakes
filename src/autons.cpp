...
void Red_Neg() 
{
//chasis.pid_forward(drive)/backwards(-in)/turn_set(in,drivespeed) 
//put preload on allience
doinker_rev();
fishtail.move(150);
pros::delay(600);
fishtail.move(-30);
...
//turns to mogo
chassis.pid_turn_set(31,TURN_SPEED);
chassis.pid_wait();
...
chassis.pid_drive_set(53,DRIVE_SPEED);
chassis.pid_wait();

//Head to ladder
chassis.pid_turn_set(-99, TURN_SPEED);
